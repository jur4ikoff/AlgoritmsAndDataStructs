...
void print_menu(void)
{
    printf(">>Возможности программы\n"
           ...
           " 8 - Вывод результатов использования различных алгоритмов сортировок\n"
           " 9 - Вывод результатов сравнения эффективности работы программы\n"
           " 10 - Вывести иформацию о программе\n");
}
