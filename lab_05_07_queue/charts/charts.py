...
ax.plot(
    ...
    df_memory["static"],
    c="red",
    label="Размер стека на основе массива",
)
ax.plot(
    df_memory["size"],
    df_memory["list"],
    c="blue",
    label="Размер стека на основе списка",
)
...
plt.grid(True)
plt.savefig(f"{data_directory}/charts/memory_chart_5.svg")
plt.show()
...
ax.plot(
    ...
    speed_memory["static"],
    c="red",
    label="Скорость стека на основе массива",
)
ax.plot(
    speed_memory["size"],
    speed_memory["list"],
    c="blue",
    label="Скорость стека на основе списка",
)
...
plt.legend(loc="upper left")
plt.grid(True)
plt.savefig(f"{data_directory}/charts/speed_chart_5.svg")
plt.show()
